...
<body style="background-image:url(../doctor/images/d113.jpg)";>
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										...
										<li ><a href="Add_descripiton.php"><i class="fa fa-tachometer"></i>Add Description
