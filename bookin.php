								...
								<ul class="nofitications-dropdown">
										...
										<ul class="dropdown-menu">
											<li>
												<div class="notification_header">
													<h3>You have 11 new messages</h3>
												</div>
											</li>
											<li><a href="#">
											   <div class="user_img"><img src="../doctor/images/in11.jpg" alt=""></div>
											...
											<li class="odd"><a href="#">
												<div class="user_img"><img src="../doctor/images/in10.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Dr abc </p>
												<p><span>1 hour ago</span></p>
												</div>
											...
											<li><a href="#">
											   <div class="user_img"><img src="../doctor/images/in9.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Dr abc</p>
												<p><span>1 hour ago</span></p>
												</div>
									...
									<li class="dropdown head-dpdn">
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
												<div class="user_img"><img src="../doctor/images/in8.jpg" alt=""></div>
											   <div class="notification_desc">
											 ...
											 <li class="odd"><a href="#">
												<div class="user_img"><img src="../doctor/images/in6.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
											 ...
											 <li><a href="#">
												<div class="user_img"><img src="../doctor/images/in7.jpg" alt=""></div>
											   <div class="notification_desc">
												<p>Lorem ipsum dolor</p>
												<p><span>1 hour ago</span></p>
												</div>
								...
								<ul>
									<li class="dropdown profile_details_drop">
										...
										<ul class="dropdown-menu drp-mnu">
											...
											<li> <a href="profile_edit.php"><i class="fa fa-user"></i> Profile</a> </li>
...
<!--heder end here-->
		<ol class="breadcrumb">
               <font color="Blue">Home </font>> <font color="red">Booking</font>
				  </ol>
...
<table width="900" height="300" background="C:\wamp\www\qcdok.com\doctor\images\in8.jpg" bgcolor="#F5F4F4" cellspacing="10">
</div>
<tr><td>Booking No.</td><td><input type="text" placeholder="Enter id" name="id" required></td></tr>
<tr><td>Specialization</td><td><select  style=" width:30%; padding:5px 8px; margin-top:2px" name="specialisation_id" id="txtSpecialization">
                         <option value="0">Select</option>
                         <?php while($row=mysql_fetch_array($sql)){?>
                         <option value="<?php echo $row['question_id']; ?>"><?php echo $row['question']; ?></option>
                         <?php } ?>
                         </select></tr>
<tr><td>Doctors</td><td><select  style=" width:30%; padding:5px 8px; margin-top:2px" name="Doctor_id" id="txtdoctor_id">
                         <option value="0">Select</option>
                         <?php while($row=mysql_fetch_array($sql)){?>
                         <option value="<?php echo $row['question_id']; ?>"><?php echo $row['question']; ?></option>
                         <?php } ?>
...
<tr><td>Date</td><td><input type="Date" name="date" required></td></tr>
 ...
 <center>
<tr><td><button type="button" onclick="makeVisible()" class="btn btn-success">Check</button></td></tr><br><br>
</center>
</table>
...
<div id="sections" style="display:none;">
 <form>
<center>
 <center> <label>MORNING SECTION</label><br><br></center>
<button type="button" onclick="" class="btn-default">9:00-9:30</button> &nbsp;&nbsp;&nbsp; 
 <button type="button" onclick="" class="btn-default">9:30-10:00</button>&nbsp;&nbsp;&nbsp; 
 <button type="button" onclick="" class="btn-default">10:00-10:30</button>&nbsp;&nbsp;&nbsp; <br><br>
 <button type="button" onclick="" class="btn-default">10:30-11:00</button>&nbsp;&nbsp;&nbsp;
<button type="button" onclick="" class="btn-default">11:00-11:30</button>&nbsp;&nbsp;&nbsp; 
 <button type="button" onclick="" class="btn-default">11:30-12:00</button>&nbsp;&nbsp;&nbsp; <br><br>
<center> <label>AFTERNOON SECTION</label><br><br></center>
 <button type="button" onclick="" class="btn-default">3:30-4:00</button>&nbsp;&nbsp;&nbsp; 
 <button type="button" onclick="" class="btn-default">4:00-4:30</button>&nbsp;&nbsp;&nbsp;  <br><br>
 <button type="button" onclick="" class="btn-default">4:30-5:00</button>&nbsp;&nbsp;&nbsp; 
 <button type="button" onclick="" class="btn-default">5:00-5:30</button>&nbsp;&nbsp;&nbsp; <br><br>
