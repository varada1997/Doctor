...
<!--heder end here-->
		<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="../admin/index.html">Home</a> <i class="fa fa-angle-right"></i></li>
                        ...
                        <form name="Specialization edit" action="specialization_edit_process.php" method="post">	
                       <?php 
include("connect.php");
$c_id=$_GET['c_id'];
$qry=mysql_query("select * from specialization where specialization_id='$c_id'");
$row=mysql_fetch_array($qry);
?>	
					<div align="center" style="border:1px">
                         Specialization: &nbsp &nbsp
						<input type="text" value="<?php echo $row['field_name'] ?>" name="c_name" required>
                         <input type="hidden" value="<?php echo $row['specialization_id'] ?>" name="c_id">
                         <!--Category Details:
					...
					<div class="clearfix"></div>
					<div >-->
							&nbsp &nbsp<input type="submit" class="btn btn-success" value="Edit">
					</div>
					</form>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li ><a href="../admin/admin_home.php"><i class="fa fa-tachometer"></i>Home
										 ...
										 <li id="menu-academico" ><a href="#"><span>Add New</span><div class="clearfix"></div></a></li>
