										...
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">
												...
												<div class="user-name">
													...
													<P><span>DR.VARADA NAIR</span></p>
													<p><span>MBBS,MD</span></p>
												</div>
...
<tr><td width="30%">Name:</td><td><input type="text" placeholder="Enter Name" name="name" required></td>
</tr>
<tr><td>Address:</td><td><textarea rows="2" cols="20"placeholder="Enter Address" name="add" required></textarea> </td>
</tr>
<tr><td>Email:</td><td><input type="text" placeholder="Enter Email" name="email" required></td></tr>
<tr><td>Phone number:</td><td><input type="text" placeholder="Enter_phone_number" name="number" required></td></tr>
...
<!--<tr><td>Experience:</td><td><input type="text" placeholder="Enter Experience" name="experienced" required></td></tr>-->
  ...
  <tr><td>Experience:</td><td><select style=" width:19%; padding:5px 8px; margin-top:2px"><option value= "0,">SELECT</option>
...
<tr><td>Current working:</td><td><input type="text" style=" width:19%" placeholder="Enter current working" name="current" required></td></tr>
...
<tr><td><td><button type="button" onclick="alert('Completed!')" class="btn btn-success">Save</button>
&nbsp<button type="button" onclick="alert('Are you sure..!')"  class="btn btn-warning">Cancel</button></td></td></tr>
</table>
